...
vim.keymap.set('i', '<D-s>', '<Esc><cmd>w<CR>', { noremap = true, silent = true })
...
-- quit file
vim.keymap.set('n', '<D-x>', '<cmd> q <CR>', opts, { noremap = true, silent = true })

-- delete single character without copying into register
vim.keymap.set('n', 'x', '"_x', opts)

-- Vertical scroll and center
vim.keymap.set('n', '<D-d>', '<C-d>zz', opts)
vim.keymap.set('n', '<D-u>', '<C-u>zz', opts)
